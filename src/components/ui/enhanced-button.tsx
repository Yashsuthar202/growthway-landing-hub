  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:opacity-90 shadow-strong hover:shadow-strong hover:scale-105 transition-bounce border-0",
        growth: "bg-growth-primary text-white hover:bg-growth-dark shadow-medium hover:shadow-strong transition-smooth",
        trust: "bg-trust-blue text-white hover:bg-trust-light shadow-soft hover:shadow-medium transition-smooth"
      },
      size: {
